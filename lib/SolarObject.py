...
class SolarObject:
    ...
    def __init__(self,
        ...
        if (NAME!="sun"):
            self.orbit_velocity = 3.14/ORBIT_DURATION
        else:
            self.orbit_velocity = 0.0
        if (NAME!='sun')&(NAME!="moon")&(NAME!="io")&(NAME!="europa")&(NAME!="ganymede"):
            self.rotation_velocity = 3.14/ROTATION_DURATION        
        else:
        ...
        self.orbit_inclination_node.Transform.value = avango.gua.make_rot_mat(self.orbit_inclination,1.0, 0.0, 1.0)
        ...
        if NAME!= 'sun':
        	self.vis=OrbitVisualization(self.orbit_inclination_node, self.orbit_radius)
